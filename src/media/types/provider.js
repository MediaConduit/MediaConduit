...
exports.GenerationRequestSchema = zod_1.z.object({
    ...
    input: zod_1.z.any(), // RAW Role object(s) - matches transform() signature
    options: zod_1.z.record(zod_1.z.any()).optional(), // Transform options - matches transform() signature  
    parameters: zod_1.z.record(zod_1.z.any()).optional(), // Legacy - for backward compatibility
