/**
 * Test script to verify Whisper service migration from GitHub
 */

import { ServiceRegistry } from './src/media/registry/ServiceRegistry';

async function testWhisperServiceMigration() {
  console.log('🔍 Testing Whisper Service Migration from GitHub\n');
  ...
  try {
    ...
    console.log('\n2. Loading Whisper service from GitHub...');
    ...
    console.log('\n✅ WHISPER SERVICE MIGRATION TEST COMPLETE!');
...
// Run the test
testWhisperServiceMigration().catch(console.error);
